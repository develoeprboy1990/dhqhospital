    ...
    <div class="table table-striped table-bordered table-responsive" style="width: 100%; background-color: #e4e0e040; margin-top: 10px;">
        ...
        <tbody>
            ...
            foreach ($query as $result_array) { 
                ...
                $sql = "SELECT * FROM `testcategories` WHERE id=".$result_array->test_id;
            ...
            <tr style="font-weight: bold; text-align: left;">
                <td width="16%"><?php echo $query[0]['name']; ?></td>

                <td width="6%"><?php echo $result_array->WardTest; ?></td>
                <td width="6%"><?php echo $result_array->WardTest*$price; ?></td>
                
                <td width="6%"><?php echo $result_array->CasualtyTest; ?></td>
                <td width="6%"><?php echo $result_array->CasualtyTest*$price; ?></td>

                <td width="6%"><?php echo $result_array->LRoomTest; ?></td>
                <td width="6%"><?php echo $result_array->LRoomTest*$price; ?></td>

                <td width="6%"><?php echo $result_array->EntitledTest; ?></td>
                <td width="6%"><?php echo $result_array->EntitledTest*$price; ?></td>

                <td width="6%"><?php echo $result_array->SSPTest; ?></td>
                <td width="6%"><?php echo $result_array->SSPTest*$price; ?></td>
                
                <td width="6%"><?php echo $result_array->PaidTest; ?></td>
                <td width="6%"><?php echo $result_array->PaidTest*$price; ?></td>

                <td width="6%"><?php echo $result_array->TotalTests; ?></td>
                <td width="6%"><?php echo $result_array->TotalTests*$price; ?></td> 
            </tr>
          <?php } ?>
        </tbody>
        <tfoot>
