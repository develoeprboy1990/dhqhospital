...
if($row['sub_dept_id']!=NULL){
  $dept_id = $row['sub_dept_id'];
} else {
  $dept_id = $row['dept_id'];
}
$dept_sql = "SELECT dep_name FROM `departments` WHERE id=".$dept_id;
$dept_query = $this->db->query($dept_sql)->result_array();
          ...
          <table class="patientinfo" width="100%" border="0" cellpadding="5" cellspacing="0">
            <thead>
              ...
              <tr >
                ...
                <th class="title" align="left">Dep</th>
                <td class="colon">:</td>
                <td align="left"><?php echo $row['dep_name'] ?></td>
              </tr>

               <tr >
                <th class="title" align="left">Ref #</th>
                <td class="colon">:</td>
        ...
        <table class="ptntTotal" width="100%" border="0" cellpadding="5" cellspacing="0">
            <thead>
              <tr >
               ...
               <tr >
                <td><?php echo $dept_query[0]['dep_name']; ?></td>
