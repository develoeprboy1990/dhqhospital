...
table.table tbody tr:nth-child(odd):hover td {
    ...
    <form method="post" action=""  id="other_form" autocomplete="off">
        ...
        <div class="col-md-4">
            ...
            <label>Recept #:</label>
            <input type="text" class="form-control" name="receptNumber" id="receptNumber" readonly value="<?php echo $nick[0]['dept_nick']; ?>-<?php if(isset($invno['yearly_no']) && $invno['yearly_no'] != ''){ echo $invno['yearly_no']; } else { echo substr(date('Y'), 2); }  ?>-<?php 
if(isset($invno['receptNumber']) && $invno['receptNumber'] != ''){ echo $invno['receptNumber']+1; }else{
    echo '1'; }?>" />
        </div>
        ...
        <div class="col-md-4">
            <label>Shift:</label>
            <input type="text" class="form-control" name="shift" id="shift" readonly value="<?php echo $this->session->userdata('shift');?>"  />
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if($.trim(data) == 'success')
                {
                   ...
                   // alert('<?php echo base_url('/Login/logout'); ?>');
