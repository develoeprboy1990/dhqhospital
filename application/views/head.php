<head>
  ...
  <link rel="icon" href="<?php echo base_url();?>images/dhq.jpg" type="image/ico">
  ...
  <!-- sweet alert -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/dist/sweetalert.css">
  <!-- Ionicons -->
  ...
  <style type="text/css">
    ...
    height: 100%;
    z-index: 9999;
    background: url('../loading/load2.gif') 50% 50% no-repeat rgb(249,249,249);
    opacity: .8;
    }
