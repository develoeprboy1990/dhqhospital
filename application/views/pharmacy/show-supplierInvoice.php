        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="<?php echo base_url("/SupplierInvoice/edit_invoice/".$row->id);?>"><i class="fa fa-pencil"></i></a>
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>/SupplierInvoice/deleteSupplierInvoice/'+id);
            }
        );
    }
    </script>