    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">All Indent Invoices</li>
      </ol>
    </section>
        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="<?php echo base_url("/UnitIndent/EditIndentInvoice/".$row->id);?>"><i class="fa fa-pencil"></i></a>
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>/UnitIndent/deleteIndentInvoice/'+id);
            }
        );
    }
    </script>
    ...
    <script>
        $(document).ready(function(){
            $('#indent_type').on('change',function(){
                var type=$(this).val();
                // alert(type);
                    $.ajax({
                               url:"<?php echo base_url('UnitIndent/fetchInvoiceByType') ?>",
                               method:"POST",
                               data:{type:type},
