...
<div class="panel-body">
 <div class="row">
   <div class="col-md-7">
     <form action="<?php echo base_url('Product/add_type') ?>" method="POST" class="form-horizontal">
      
                <div class="form-group">
                  <label for="Name" class="col-sm-2 control-label">Type Name :</label>
                    <span id="name_error" style="color: red;font-size: 11px;"></span>
                  <div class="col-sm-5">
                     <input type="text" required="" class="form-control" placeholder="Type Name" name="name" id="name" required />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select name="indent_type" required="" id="" class="form-control">
    ...
    <?php } ?>
                 ...
                 <div class="form-group">
                   <div class="col-md-4 col-md-offset-3">
                     <input type="submit" value="Save Type" name="save" style="width: 150px;color: green;font-weight: bold;height: 40px !important;border-radius:10px;font-size: 20px">
                   </div>
                 </div>
                </form>
   </div>
