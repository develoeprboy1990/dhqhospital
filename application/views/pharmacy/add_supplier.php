...
<div class="panel-body">
 <div class="row">
   <div class="col-md-7">
     <form action="<?php echo base_url('SupplierInvoice/add_supplier') ?>" method="POST" class="form-horizontal">
     ...
     <option value="" selected="" disabled="">Select Supplier</option>
              ...
              <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                     <input type="text" class="form-control" placeholder="Vendor Name" name="vendor_name" id="vendor_name" required />
