  ...
  width: 30%;
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Ward Incharge</li>
      </ol>
    </section>
...
<div class="panel-body">
 <div class="row">
   <div class="col-md-7">
     <form action="<?php echo base_url('OtherPharmacy/edit_wardIncharge/'.$id) ?>" method="POST" class="form-horizontal">
                <div class="form-group">
                 ...
                 <div class="form-group">
                   <div class="col-md-4 col-md-offset-3">
                     <input type="submit" value="Update Incharge" name="update_incharge" style="width: 150px;color: green;font-weight: bold;height: 40px !important;border-radius:10px;font-size: 20px">
                   </div>
                 </div>
                </form>
   </div>
