    ...
    <a style="float: right; margin: 10px;" href="<?php echo base_url('Product/add_product');?>"><button class="btn btn-primary">Add New</button> </a>
        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="<?php echo base_url("/Product/edit/".$row->id);?>"><i class="fa fa-pencil"></i></a>
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>/Product/delete/'+id);
            }
        );
    }
    </script>