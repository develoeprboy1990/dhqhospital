  ...
  width: 30%;
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Store Keeper</li>
      </ol>
    </section>
...
<div class="panel-body">
 <div class="row">
   <div class="col-md-7">
     <form action="<?php echo base_url('OtherPharmacy/add_storekeeper') ?>" method="POST" class="form-horizontal">
               
                <div class="form-group">
                  <label for="Name" class="col-sm-2 control-label">Pharmacist Name :</label>
                    <span id="name_error" style="color: red;font-size: 11px;"></span>
                  <div class="col-sm-5">
                     <input type="text" class="form-control" placeholder="Pharmacist Name" name="pharmacist_name" id="vendor_name" required />
                 ...
                 <div class="form-group">
                   <div class="col-md-4 col-md-offset-3">
                     <input type="submit" value="Save Pharmacist" name="save" style="width: 150px;color: green;font-weight: bold;height: 40px !important;border-radius:10px;font-size: 16px">
                   </div>
                 </div>
                </form>
   </div>
