    ...
    <a style="float: right; margin: 10px;" href="<?php echo base_url('Lab_test/add');?>"><button class="btn btn-primary">Add New</button> </a>
        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="<?php echo base_url("/Lab_test/edit/".$row->id);?>"><i class="fa fa-pencil"></i></a>
    ...
    function validate(a)
    {
        ...
        swal({
            ...
            {
                swal("Deleted!", "Lab test has been Deleted.", "success");
                $(location).attr('href','<?php echo base_url()?>/Lab_test/delete/'+id);
            }
        );
    }
    </script>