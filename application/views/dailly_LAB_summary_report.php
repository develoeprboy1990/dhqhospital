    ...
    <div class="table table-striped table-bordered table-responsive" style="width: 100%; background-color: #e4e0e040; margin-top: 10px;">
        ...
        <thead>
              <tr style="background-color: #3c8dbc; color: #FFFFFF; font-weight: bold; text-align: left;">
                ...
                <td width="10%;" colspan="2">SSP</td>
                <td width="10%;" colspan="2">Paid</td>
                <td width="10%;" colspan="2">Total</td>
            
            </tr>
            <tr style="font-weight: bold; text-align: left;">
                <td width="20%;">Date</td>
                <td width="5%;">From</td><td width="5%;">To</td>
                 <td width="5%;">Count</td><td width="5%;">Amount</td>
                 <td width="5%;">Count</td><td width="5%;">Amount</td>
                 <td width="5%;">Count</td><td width="5%;">Amount</td>
                 <td width="5%;">Count</td><td width="5%;">Amount</td>
                 <td width="5%;">Count</td><td width="5%;">Amount</td>
...
for ( $i = $startTime; $i <= $endTime; $i = $i + 86400 ) {
  ...
  $sql = "SELECT MIN(dated) AS date, 
      ...
      SUM(if(type = 'SSP',tests,0)) AS SSPTests,
      SUM(if(type = 'SSP',price,0)) AS SSPAmount,
...
<?php } ?>
            <?php 
                $paidTotal = $MPAA = $TotalPaidAmount = 0;
                $morningSql = $eveningSql = $nightSql = "";
                $timestamp = strtotime($thisDate);
                $day = date('l', $timestamp);
                $date = " AND date >= '$thisDate_from' and date <'$thisDate_to'";

                
                $fromDate = explode(' ', $thisDate_from);
                $totalAmounts = $result_array->WardAmount + $result_array->CasualtyAmount + $result_array->LRoomAmount + $result_array->EntitledAmount + $result_array->SSPAmount + $result_array->PaidAmount;
            ...
            <tr <?php if($day=='Sunday'){ ?> style="font-weight: bold; text-align: left; background: green; color: #FFFFFF;" <?php } else { ?> style="font-weight: bold; text-align: left;" <?php } ?>>
                ...
                <td width="5%;"><?php echo $result_array->serialStart; ?></td>
                <td width="5%;"><?php echo $result_array->serialEnd; ?></td>

                <td width="5%;"><?php echo $result_array->WardTests; ?></td>
                <td width="5%;"><?php echo $result_array->WardAmount; ?></td>
                
                <td width="5%;"><?php echo $result_array->CasualtyTests; ?></td>
                <td width="5%;"><?php echo $result_array->CasualtyAmount; ?></td>

                <td width="5%;"><?php echo $result_array->LRoomTests; ?></td>
                <td width="5%;"><?php echo $result_array->LRoomAmount; ?></td>

                <td width="5%;"><?php echo $result_array->EntitledTests; ?></td>
                <td width="5%;"><?php echo $result_array->EntitledAmount; ?></td>

                <td width="5%;"><?php echo $result_array->SSPTests; ?></td>
                <td width="5%;"><?php echo $result_array->SSPAmount; ?></td>
                
                <td width="5%;"><?php echo $result_array->PaidTests; ?></td>               
                <td width="5%;"><?php echo $result_array->PaidAmount; ?></td>
                
                <td width="5%;"><?php echo $result_array->totalQuantity; ?></td>
                <td width="5%;"><?php echo $totalAmounts; ?></td> 
            </tr>
            <?php  } } ?>
