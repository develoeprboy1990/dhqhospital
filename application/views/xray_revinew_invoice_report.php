...
?>
    ...
    <form method="post" action="<?php echo base_url('XRAY_Report/revinew_invoice') ?>">
          ...
          <div class="table-responsive">
            <table class="table"> 
              <tr>
                ...
                <td style="width: 25%;"><?php echo $result_array[0]->SerialEndTo-$result_array[0]->SerialStartFrom+1; ?><small style="font-size: 10px;">(Total Reciepts)</small></td>
              </tr>
              <tr>
                <td>Total:</td>
                <td><?php echo $result_array[0]->TotalReceipts ?><small style="font-size: 10px;">(Patients)</small></td>
                <td><?php echo $result_array[0]->TotalTests ?><small style="font-size: 10px;">(Films)</small></td>
                <td> <?php echo $result_array[0]->TotalTestsAmount ?><small style="font-size: 10px;">(Films Amount)</small></td>
              </tr>
              <tr>
                <td>Paid:</td>
                <td>
              ...
              <td>
                <?php 
                  ...
                  <small style="font-size: 10px;">(Films)</small>
                <?php } else { echo 0; } ?>
              </td>
               <td>
                <?php 
    ...
    <div class="row no-print">
        <div class="col-xs-12">
          <a href="<?php echo base_url('XRAY_Report/xray_revinew_invoice_print_report/'.date('Y-m-d',strtotime($date)).'/'.$dept_id.'/'.$shift) ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
