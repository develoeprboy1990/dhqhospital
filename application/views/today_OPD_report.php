...
?>
    <form method="post" action="<?php echo base_url('OPD_Report/') ?>">
        ...
        <tbody>
            ...
            <tr style="text-align: center; font-weight: bold; text-align: center;">
                ...
                ?>            
                 ...
                 <td><?php echo $get_District[0]['name']; ?></td>
                ...
                <?php
                 ...
                 <td style="color: green"><a href="<?php echo base_url('OPD_Report/opd_print_report/'.$idss.'/'.$row->receptNumber) ?>" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>
                    <?php 
                    $is_admin=$this->session->userdata('is_admin'); 
                    if($is_admin==1){ ?>  
                        <a href="<?php echo base_url('OPD_Report/opd_delete_report/'.$idss.'/'.$row->receptNumber) ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    <?php }
                    ?>
    ...
    <script type="text/javascript">
     //    $(function () {
        ...
        $('#sync').on('click',function(e){
                ...
                $.ajax({
                url:'<?php echo base_url('login/syncDataOpd') ?>',
                method:'POST',
