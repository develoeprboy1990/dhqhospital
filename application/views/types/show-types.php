    ...
    <a style="float: right;" href="<?php echo base_url('Type/add');?>"><button class="btn btn-primary">Add New</button> </a>
        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="# "><i class="fa fa-pencil"></i></a>
                    </td>
                    <td>
                    <button class="btn-sm btn-danger" disabled onclick="validate(this)" value="<?=$row->id; ?>"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
           <?php
                $i++;
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>/Type/delete/'+id);
            }
        );
    }
    </script>