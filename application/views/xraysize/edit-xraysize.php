    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit XRAY Size</li>
      </ol>
    </section>
    ...
    <form method="post" action="<?php echo base_url('XRAY_size/edit/'.$id);?>">
        <div class="col-md-4">
        <label>Xray Size:</label>
        <input type="text" class="form-control"  name="title" id="title" value="<?php echo $record[0]['title'] ?>"  />
        <br />
        </div>
        <div class="col-md-4">
        <label>Price:</label>
        <input type="number" class="form-control"  name="price" id="price" value="<?php echo $record[0]['price'] ?>"  />
        <br />
        </div>
