...
<a data-toggle="collapse" data-parent="#faq" href="#answerOne" aria-expanded="true" aria-controls="answerOne">
    ...
    <a style="float: right; margin: 10px;" href="<?php echo base_url('Laboratory/SubTestCategory');?>"><button class="btn btn-primary">Add New</button> </a>
        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                    <a class="btn-sm btn-success" href="<?php echo base_url("/Laboratory/EditSubTestCategory/".$row->id);?>"><i class="fa fa-pencil"></i></a>
