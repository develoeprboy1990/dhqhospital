...
<div class="panel-body">
 <div class="row">
   <div class="col-md-7">
     <form action="<?php echo base_url('Laboratory/SubTestCategory/'.$this->uri->segment(3)) ?>"  method="POST" class="form-horizontal">
                <div class="col-md-4">
                  <label>Select Category : </label>
                  <select name="sub_category" class="form-control" required="" >                 
                      <option value="">Select Test Category</option>
                      <?php  foreach ($data as $row) { ?>
                        <option <?php if($this->uri->segment(3)==$row->id){ echo "selected"; } ?> value="<?php echo $row->id ?>"><?php echo $row->name ?></option>
                      <?php } ?>
                  </select>
                  <br />
                </div>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-3" style="margin-top: 25px;">
                    <div align="center">
                      <a href="<?php echo base_url('Laboratory/ShowCateWiseSub/'.$this->uri->segment(3)); ?>" class="btn btn-danger"> Cancel </a>
