...
<a data-toggle="collapse" data-parent="#faq" href="#answerOne" aria-expanded="true" aria-controls="answerOne">
    ...
    <a style="float: right; margin: 10px;" href="<?php echo base_url('Laboratory/AddTestResult/'.$this->uri->segment(3));?>"><button class="btn btn-primary">Add Test Result</button> </a>
    <div class="table table-striped table-bordered table-responsive" style="width: 100%; background-color: #e4e0e040; margin-top: 10px;">
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <a class="btn-sm btn-success" href="<?php echo base_url("/Laboratory/EditTestResult/".$row->id);?>"><i class="fa fa-pencil"></i></a>
                    
                    <button class="btn-sm btn-danger"  value="<?=$row->id; ?>" onclick="validate(this)" ><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
           <?php
                $i++;
      ...
      <div class="modal fade" id="ShowTestResult" tabindex="-1" role="dialog">
    ...
    <div class="modal-content">
      <table>
        ...
        <tbody>
          <tr>
            <td></td>
            <td><a href="#" onclick="" value="" class="fa fa-trash"></a> | <a href="#" class="fa fa-pencil"></a></td>
          </tr>
        </tbody>
      </table>   
    </div> <!-- /modal-content -->    
    ...
    function validate(a)
    {
        ...
        swal({
                ...
                closeOnConfirm: false }, function()
            {
                ...
                $(location).attr('href','<?php echo base_url()?>/Laboratory/DeleteTestResult/'+id);
            }
        );
    }
    </script>