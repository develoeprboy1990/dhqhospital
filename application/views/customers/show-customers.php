        ...
        <table id="example1" class="table table-hover table-bordered" style="background-color: #ebebe0;">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php if(!empty($row->username)) echo $row->username; else echo "Not Available"; ?>
                    </td>
                    <td>
                        <?php if(!empty($row->mobile)) echo $row->mobile; else echo "Not Available"; ?>
                    </td>
                    <td>
                        <?php if(!empty($row->email)) echo $row->email; else echo "Not Available"; ?>
                    </td>
                    <td>
                        <?php if(!empty($row->shift)) echo $row->shift; else echo "Not Available"; ?>
                    </td>
