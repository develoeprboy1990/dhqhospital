   ...
   <!--  <div class="panel-heading" align="center" style="color:red;"> Add Class Here </div> -->
    ...
    <form method="post" action="<?php echo base_url('User/edit/'.$id);?>">
         ...
         <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="fname" value="<?php echo $record[0]['name'] ?>" autocomplete="off" /><br />
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="username" required value="<?php echo $record[0]['username'] ?>" autocomplete="off" /><br />
        </div>
        ...
        <div class="col-md-4">
            <label>Phone:</label>
        <input type="number" class="form-control" pattern="[0-9]{11}" maxlength="11" name="mobile" value="<?php echo $record[0]['mobile'] ?>" autocomplete="off" /><br />
        </div>
