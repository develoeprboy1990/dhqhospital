                ...
                $totalTests += $query_lab_test->num_rows();
                 ...
                 <td style="color: green"><?php echo $row->price."/="; ?></td>
                  <td style="color: green;">
                    <a data-entryid="<?php echo $row->receptNumber; ?>" data-dept_id="<?php echo $row->dept_id; ?>" data-yearly_no="<?php echo $row->yearly_no; ?>" class="lab-invoice" title="Ivoice">Print</a> | 
