                  ...
                  <td>
                    ...
                    <table class="about-patient">
                      ...
                      <tr>
                        <td>Shift</td>
                        <td>:</td>
                        <td><span><?php echo $shift; ?>&nbsp</span></td>
                      </tr>
                      <tr>
                        <td>Date</td>
                        <td>:</td>
        ...
        <tr>
          <td>
            ...
            <body>
              ...
              <?php 
                  $totalAmount = $result_array[0]->PaidTestsAmount + $result_array[0]->CasualtyTestsAmount + $result_array[0]->WardTestsAmount + $result_array[0]->LabourRoomTestsAmount + $result_array[0]->EntitledTestsAmount + $result_array[0]->SSPTestsAmount; 
                ?>
              <tr>
                <td>Total:</td>
                ...
                <td> <?php echo $totalAmount ?><small style="font-size: 10px;">(Tests Amount)</small></td>
              </tr>
              <tr>
                <td>Paid:</td>
                <td>
              ...
              <tr>
                ...
                <td>
                <?php 
                  if($result_array[0]->SSPReceipts!='' || $result_array[0]->SSPReceipts!=0){ 
                  echo $result_array[0]->SSPReceipts ?>
                  <small style="font-size: 10px;">(Receipts)</small>
                <?php } else { echo 0; } ?>
              </td>
              <td>
                <?php 
                  if($result_array[0]->SSPTests!='' || $result_array[0]->SSPTests!=0){ 
                  echo $result_array[0]->SSPTests ?>
                  <small style="font-size: 10px;">(Tests)</small>
                <?php } else { echo 0; } ?>
              </td>
               <td>
                <?php 
                  if($result_array[0]->SSPTestsAmount!='' || $result_array[0]->SSPTestsAmount!=0){ 
                  echo $result_array[0]->SSPTestsAmount ?>
                  <small style="font-size: 10px;">(Amount)</small>
                <?php } else { echo 0; } ?>
              </td>
              </tr>
