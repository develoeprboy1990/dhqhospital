...
class Profiles extends CI_Model
{
	...
	{
		$result = $this->db->SELECT('a.id, a.f_name, a.l_name, a.username, a.contact, a.email, a.is_admin,a.user_nick, a.security_type, a.add_date, b.id as dept_id, b.user_id, c.dep_name')->FROM('user as a')
